...
const handler = async(req, res) => {
    try {
        ...
        if(req.body.emailid&&req.body.emailid.trim()!=""){
            matchFilter.$match.emailid = {$regex:req.body.emailid,$options: 'i'};
        }
        ...
        const userUsingOffset = await Users.aggregate(filterObjectArray)
        
        totalDataFilter.push(countFilter);
        const totalData = await Users.aggregate(totalDataFilter)
