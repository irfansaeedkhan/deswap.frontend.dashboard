...
/** 
 *@api {post} /api/users/nftlicensefees/fetch/ Fetch NFT license fees
    *@apiName FetchNFTlicensefees
    *@apiGroup User/NFTLicense
    *@apiVersion 1.0.0
    *@apiDescription Fetch NFT license fees
    *@apiBody [skip] (number)
    *@apiBody [limit] (number)
    *@apiExample {axios} Example usage:
    *axios.post('/api/users/nftlicensefee/fetch/', {
    *  skip: 0,
    * limit: 10
    * })
