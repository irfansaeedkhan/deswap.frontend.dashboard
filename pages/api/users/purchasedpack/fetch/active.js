...
/**
 * @api {post} /api/users/purchasedpack/fetch/active/ Fetch Purchased Pack Active
 * @apiName FetchPurchasedPackActive
 * @apiGroup User/Pack
 * @apiVersion 1.0.0
 * @apiDescription Fetch Purchased Pack Active
 * @apiBody {Number} [skip=0]
 * @apiBody {Number} [limit=10]
 * @apiExample {axios} Example usage:
 * axios.post('/api/users/purchasedpack/fetch/active/', {
 * skip: 0,
 * limit: 10
 * })
