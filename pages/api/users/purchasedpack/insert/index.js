...
/**
 * @api {post} /api/users/purchasedpack/insert Fetch Purchased Pack Insert
 * @apiName FetchPurchasedPackInsert
 * @apiGroup User/Pack
 * @apiVersion 1.0.0
 * @apiDescription Fetch Purchased Pack Insert
 * @apiBody {Number} [skip=0]
 * @apiBody {Number} [limit=10]
 * @apiExample {axios} Example usage:
 * axios.post('/api/users/purchasedpack/insert', {
 * skip: 0,
 * limit: 10
 * })
