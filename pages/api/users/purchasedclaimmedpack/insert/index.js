...
/**
 * @api {post} /api/users/purchasedclaimmedpack/insert/ Insert Purchased Claim Med Pack
 * @apiName InsertPurchasedClaimMedPack
 * @apiGroup User/Pack
 * @apiVersion 1.0.0
 * @apiDescription Insert Purchased Claim Med Pack
 * @apiBody {Number} [skip=0]
 * @apiBody {Number} [limit=10]
 * @apiExample {axios} Example usage:
 * axios.post('/api/users/purchasedclaimmedpack/insert/', {
 * skip: 0,
 * limit: 10
 * })
