...
function rewardnft() {
  ...
  const completeCheckout = async () => {
    ...
    await setModalBody(
      <div className="rewardnftModal">
        ...
        <h4>Quantum Unlocked</h4>
        <h5>
          Robbie Trevino on Twitter-<span>55c345C3UV</span>
        </h5>
    ...
    setModalBody(
      <div className="rewardnftModal">
        ...
        <h5 style={{ color: "#858585", lineHeight: "20px" }}>
          ...
          <span style={{ color: "#ffffff" }}>Quantum Unlocked</span> for{" "}
      ...
      await setModalBody(
        <div className="rewardnftModal">
          ...
          <h5 style={{ color: "#858585" }}>
            ...
            <span style={{ color: "#ffffff" }}>Quantum Unlocked NFT?</span>
          </h5>
        </div>
      );
      await setModalFooter(
  ...
  async function Processrewardnft() {
    try {
      await setShow(true);
      await setModalHeader("Stake NFT");
      await setModalBody(
  ...
  return (
    <div className="rewardnft">
      <MarketNavbar />
      <div className="rewardnftInner">
        ...
        <div className="nftDetails">
          ...
          <div className="creatorContainer">
            ...
            <div className="Content">
              <h5>Collection</h5>
              <div className="author">
                <h6>Robbie Trevino on Twitter</h6>
              </div>
            </div>
            <div className="Content">
              <h5>Views</h5>
...
export default connect(mapStateToProps, mapDispatchToProps)(rewardnft);
