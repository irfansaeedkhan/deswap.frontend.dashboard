...
function UserPublickeyFee(props) {
    ...
    const fetchPublicKeyFee = async (data) => {
        try {
            ...
            let result = await axios.post(
                `${process.env.NEXT_PUBLIC_PLATFORM_URL}/api/admin/userinfofee/fetch/publickeyfee`,
                { data: encryptionData },
                {
...
export default UserPublickeyFee;
