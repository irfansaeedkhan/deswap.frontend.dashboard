...
function UserDetailNetworkReward() {
  return (
    <div className="tableContainer">
    <p>User Detail Network Reward</p>
    <div className="tableContainerTable customScroll">
      <table cellPadding="0" cellSpacing="0" border="0">
        <thead>
          <tr>
            <th>Total Network Rewards</th>
            <th>Total Available Network Rewards</th>
            <th>Total Claimed Network Rewards</th>
            <th>Total Amount</th>
...
export default UserDetailNetworkReward