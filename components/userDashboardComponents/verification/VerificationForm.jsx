...
function VerificationForm({ userData }) {
  ...
  useEffect(() => {
      ...
      if((e.target)&&(e.target.value)){
        if (typeof valuesOFInput=="number"){
          ...
          if(valuesOFInput.length>Number(e.target.dataset.fieldposition)){
            //
            while(valuesOFInput.length>Number(e.target.dataset.fieldposition)){
              valuesOFInput.pop()
            }
          }
        }
        ...
        if(typeof valuesOFInput!="number"){
          ...
          if(valuesOFInput.length=== 6){
            ...
            try {
              ...
              let encryptionData = await requestBodyEncryptionUnprotected({ verificationCode: valuesOFInput, _id: userData.uuid })
    ...
    const handlePaste = async function (e) {
      e.preventDefault();
      const data1 = e?.clipboardData.getData("text");

      await SanitizeRequestString(data1);
        ...
        <div className="inputsList">
          <form name="verify" autoComplete="off">
            <div className="inputs">
              <div className="box">
                <input type="number" autoComplete="off" data-fieldposition="1" name="n1" maxLength="1" />
              </div>
              <div className="box">
                <input type="number" autoComplete="off" data-fieldposition="2" name="n2" maxLength="1" />
              </div>
              <div className="box">
                <input type="number" autoComplete="off" data-fieldposition="3" name="n3" maxLength="1" />
              </div>
              <div className="box">
                <input type="number" autoComplete="off" data-fieldposition="4" name="n4" maxLength="1" />
              </div>
              <div className="box">
                <input type="number" autoComplete="off" data-fieldposition="5" name="n5" maxLength="1" />
              </div>
              <div className="box">
                <input type="number" autoComplete="off" data-fieldposition="6" name="n6" maxLength="1" />
              </div>
            </div>
          </form>
